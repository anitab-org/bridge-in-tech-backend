...
class PersonalBackgroundDAO:
    ...
    def update_user_personal_background(data):
        ...
        existing_personal_background = PersonalBackgroundModel.find_by_user_id(
            int(user["id"])
        )
        ...
        try:
            ...
            existing_personal_background.sexual_orientation = SexualOrientation(
                data["sexual_orientation"]
            ).name
            existing_personal_background.religion = Religion(data["religion"]).name
            existing_personal_background.physical_ability = PhysicalAbility(
                data["physical_ability"]
            ).name
            existing_personal_background.mental_ability = MentalAbility(
                data["mental_ability"]
            ).name
            existing_personal_background.socio_economic = SocioEconomic(
                data["socio_economic"]
            ).name
            existing_personal_background.highest_education = HighestEducation(
                data["highest_education"]
            ).name
            existing_personal_background.years_of_experience = YearsOfExperience(
                data["years_of_experience"]
            ).name
