...
class MentorshipRelationExtensionModel(db.Model):
    ...
    program_id = db.Column(db.Integer, db.ForeignKey("bitschema.programs.id", ondelete="CASCADE"), nullable=False, unique=True)
    mentorship_relation_id = db.Column(db.Integer, db.ForeignKey("public.mentorship_relations.id", ondelete="CASCADE"), nullable=False, unique=True)
