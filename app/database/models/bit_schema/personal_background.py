...
class PersonalBackgroundModel(db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey("public.users.id", ondelete="CASCADE"), nullable=False, unique=True)
    ...
    others = db.Column(JSONB(none_as_null=False), default=JSONB.NULL)
    is_public = db.Column(db.Boolean)

    def __init__(self, user_id, gender, age, ethnicity, sexual_orientation, religion, physical_ability, mental_ability, socio_economic, highest_education, years_of_experience):
