...
def add_mock_data():
    ...
    user1.registration_date = 1589151600.93296 # Sunday, 10 May 2020 11:00:00.932 PM UTC+0
    user1.is_admin = True
    ...
    user2.registration_date = 1589238000.95326 # Monday, 11 May 2020 11:00:00.953 PM UTC+0
    ...
    user3.registration_date = 1589410800.82208 # Wednesday, 13 May 2020 11:00:00.822 PM UTC+0
    ...
    user4.registration_date = 1589371200.61836 # Wednesday, 13 May 2020 12:00:00.618 PM UTC+0
    ...
    user2_extension.additional_info = {
        "phone": "2130-99-11-99", "personal_website": "testtwo@github.io"}
    ...
    user3_extension.additional_info = {
        "mobile": "+44-5555-666-777", "personal_website": "testthree@github.io"}

    # user4 users_extension. Not yet confirm their email.
    user4_extension = UserExtensionModel(
        user_id = user4.id, 
        is_organization_rep = False, 
        timezone = Timezone.CHARLIE_TIME
    )
    ...
    program2.target_candidate = {"gender": Gender.FEMALE.value, "age": Age.AGE_45_TO_54.value}
    ...
    program3.target_candidate = {"physical_ability": PhysicalAbility.WITH_DISABILITY.value, "sexual_orientation": SexualOrientation.LGBTIA.value}
    ...
    mentorship_relation1.start_date = program2.start_date # Thursday, 21 May 2020 12:00:00 PM UTC+0
    ...
    mentorship_relations_extension1 = MentorshipRelationExtensionModel(
        ...
        mentorship_relation_id = mentorship_relation1.id
    )
    mentorship_relations_extension1.mentor_request_date = mentorship_relation1.creation_date
    ...
    mentorship_relations_extension1.mentor_agreed_date = 1589803200 # Monday, 18 May 2020 12:00:00 PM UTC+0
    ...
    mentorship_relations_extension1.mentee_request_date = 1589803200 # Monday, 18 May 2020 12:00:00 PM UTC+0
    # update related tables
    db.session.add(mentorship_relation1)
    db.session.add(mentorship_relations_extension1)
    db.session.commit()
    ...
    mentorship_relations_extension1.mentee_agreed_date = 1589976000 # Wednesday, 20 May 2020 12:00:00 PM UTC+0
    # update mentorship_relation state
    mentorship_relation1.state = MentorshipRelationState.ACCEPTED
    mentorship_relation1.accept_date = mentorship_relations_extension1.mentee_agreed_date
    ...
    tasks_list_1.add_task(description=tasks_list_1_task_a, created_at=1590062400) # Thursday, 21 May 2020 12:00:00 PM UTC+0 
    tasks_list_1.add_task(description=tasks_list_1_task_b, created_at=1590062400) # Thursday, 21 May 2020 12:00:00 PM UTC+0
    ...
    tasks_list_1_task_comment_a.creation_date = 1590062400 # Thursday, 21 May 2020 12:00:00 PM UTC+0 == tasks a creation date
    ...
    tasks_list_1_task_comment_a.modification_date = 1590148800 # Friday, 22 May 2020 12:00:00 PM UTC+0
    ...
    tasks_list_1_task_comment_a.modification_date = 1590235200 # Saturday, 23 May 2020 12:00:00 PM UTC+0
