...
class TestUpdatePersonalBackgroundApi(BaseTestCase):
    ...
    def test_api_dao_update_user_personal_background_successfully(self):
        ...
        existing_personal_background.is_public = (
            self.correct_payload_personal_background["is_public"]
        )
        ...
        with self.client:
            response = self.client.put(
                ...
                data=json.dumps(dict(self.correct_payload_personal_background)),
                follow_redirects=True,
                content_type="application/json",
            )
        ...
        self.assertEqual(
            test_user_personal_background_data.user_id, self.test_user_data.id
        )
        self.assertEqual(
            test_user_personal_background_data.gender.value,
            self.correct_payload_personal_background["gender"],
        )
        self.assertEqual(
            test_user_personal_background_data.age.value,
        ...
        self.assertEqual(
            test_user_personal_background_data.religion.value,
        ...
        self.assertEqual(
            ...
            self.correct_payload_personal_background["gender_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["ethnicity_other"],
            self.correct_payload_personal_background["ethnicity_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["sexual_orientation_other"],
            self.correct_payload_personal_background["sexual_orientation_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["religion_other"],
            self.correct_payload_personal_background["religion_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["physical_ability_other"],
            self.correct_payload_personal_background["physical_ability_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["mental_ability_other"],
            self.correct_payload_personal_background["mental_ability_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["socio_economic_other"],
            self.correct_payload_personal_background["socio_economic_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["highest_education_other"],
            self.correct_payload_personal_background["highest_education_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.is_public,
            self.correct_payload_personal_background["is_public"],
        )
    ...
    def test_api_dao_update_user_personal_background_invalid_payload(self):
        ...
        with self.client:
            response = self.client.put(
                "/user/personal_background",
                headers={"Authorization": AUTH_COOKIE["Authorization"].value},
                data=json.dumps(dict(test_user_personal_background)),
                follow_redirects=True,
                content_type="application/json",
            )
