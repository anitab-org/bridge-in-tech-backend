...
class TestGetUserPersonalBackgroundApi(BaseTestCase):
    ...
    def test_api_dao_get_user_personal_background_successfully(self):
        ...
        others = {
            ...
            "sexual_orientation_other": self.response_personal_background[
                "sexual_orientation_other"
            ],
            "religion_other": self.response_personal_background["religion_other"],
            "physical_ability_other": self.response_personal_background[
                "physical_ability_other"
            ],
            "mental_ability_other": self.response_personal_background[
                "mental_ability_other"
            ],
            "socio_economic_other": self.response_personal_background[
                "socio_economic_other"
            ],
            "highest_education_other": self.response_personal_background[
                "highest_education_other"
            ],
        }
        ...
        test_user_personal_background_data = PersonalBackgroundModel.query.filter_by(
            user_id=self.test_user_data.id
        ).first()
        self.assertEqual(
            test_user_personal_background_data.user_id, response.json["user_id"]
        )
        self.assertEqual(
            test_user_personal_background_data.gender.value, response.json["gender"]
        )
        self.assertEqual(
            test_user_personal_background_data.age.value, response.json["age"]
        )
        self.assertEqual(
            test_user_personal_background_data.ethnicity.value,
            response.json["ethnicity"],
        )
        self.assertEqual(
            test_user_personal_background_data.sexual_orientation.value,
            response.json["sexual_orientation"],
        )
        self.assertEqual(
            test_user_personal_background_data.religion.value, response.json["religion"]
        )
        self.assertEqual(
            test_user_personal_background_data.physical_ability.value,
            response.json["physical_ability"],
        )
        self.assertEqual(
            test_user_personal_background_data.mental_ability.value,
            response.json["mental_ability"],
        )
        self.assertEqual(
            test_user_personal_background_data.socio_economic.value,
            response.json["socio_economic"],
        )
        self.assertEqual(
            test_user_personal_background_data.highest_education.value,
            response.json["highest_education"],
        )
        self.assertEqual(
            test_user_personal_background_data.years_of_experience.value,
            response.json["years_of_experience"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["gender_other"],
            response.json["gender_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["ethnicity_other"],
            response.json["ethnicity_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["sexual_orientation_other"],
            response.json["sexual_orientation_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["religion_other"],
            response.json["religion_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["physical_ability_other"],
            response.json["physical_ability_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["mental_ability_other"],
            response.json["mental_ability_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["socio_economic_other"],
            response.json["socio_economic_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.others["highest_education_other"],
            response.json["highest_education_other"],
        )
        self.assertEqual(
            test_user_personal_background_data.is_public, response.json["is_public"]
        )
